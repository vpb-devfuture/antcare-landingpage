...
const Footer = () => {
  ...
  return (
    <footer className="bg-plum-deep text-white border-t border-white/10 py-8 md:py-10">
      ...
      {/* Minimalist Centered Social Media Section */}
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 md:px-10 lg:px-12 my-4 pt-5 border-t border-white/10">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 text-center">
          <span className="text-xs sm:text-sm font-bold uppercase tracking-wider text-earth-orange-bright flex items-center gap-1.5">
            <span className="material-symbols-outlined text-base">share</span>
            {isEn ? 'Social Media:' : 'Kênh truyền thông:'}
          </span>
